        ...
        <div class="portfolio-items">
            <div class="portfolio-item">
                <div class="controls">
                    ...
                    <a href="assets/images/stock7.jpg" class="fa fa-search"></a>
                </div>
            ...
            <div class="portfolio-item">
                <div class="controls">
                    <a href="single-project.html" class="fa fa-link"></a>
                    <a href="assets/images/stock10.jpg" class="fa fa-search"></a>
                </div>
            ...
            <div class="portfolio-item">
                <div class="controls">
                    <a href="single-project.html" class="fa fa-link"></a>
                    <a href="assets/images/stock6.jpg" class="fa fa-search"></a>
                </div>
                <h4><a href="single-project.html">Cras Facilisis</a></h4>
                <p>Cras dictum erat id tortor ornare.</p>
            ...
            <div class="portfolio-item">
                <div class="controls">
                    <a href="single-project.html" class="fa fa-link"></a>
                    <a href="assets/images/stock11.jpg" class="fa fa-search"></a>
                </div>
            ...
            <div class="portfolio-item">
                <div class="controls">
                    <a href="single-project.html" class="fa fa-link"></a>
                    <a href="assets/images/stock4.jpg" class="fa fa-search"></a>
                </div>
                <h4><a href="single-project.html">Lorem Ipsum</a></h4>
                <p>Cras dictum erat id tortor ornare.</p>
