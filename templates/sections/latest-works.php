<section class="section primary latest-works" id="s-latest-works">
    <div class="container">
        ...
        <div class="portfolio-items">
            ...
            <div class="portfolio-item">
                <div class="controls">
                    <a href="<?php echo $ROOT; ?>single-project.html" class="icon-round-borderr">
                        <i class="fa fa-link"></i>
                    </a>
            ...
            <div class="portfolio-item">
                ...
                <h4><a href="<?php echo $ROOT; ?>single-project.html">Cras Facilisis</a></h4>
                <p>Cras dictum erat id tortor ornare.</p>
                <img src="<?php echo $ROOT; ?>assets/images/stock6.jpg" alt="" />
            </div>
            <div class="portfolio-item">
                <div class="controls">
                    <a href="<?php echo $ROOT; ?>single-project.html" class="icon-round-border">
                    ...
                    <a href="<?php echo $ROOT; ?>assets/images/stock11.jpg" class="icon-round-border icon-view">
                        <i class="fa fa-search"></i>
                    </a>
                </div>
                <h4><a href="<?php echo $ROOT; ?>single-project.html">Suspendisse Tempus</a></h4>
                <p>Cras dictum erat id tortor ornare.</p>
                <img src="<?php echo $ROOT; ?>assets/images/stock11.jpg" alt="" />
            </div>
            <div class="portfolio-item">
                <div class="controls">
                    <a href="<?php echo $ROOT; ?>single-project.html" class="icon-round-border">
                    ...
                    <a href="<?php echo $ROOT; ?>assets/images/stock4.jpg" class="icon-round-border icon-view">
                        <i class="fa fa-search"></i>
                    </a>
                </div>
